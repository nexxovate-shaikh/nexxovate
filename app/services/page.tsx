      ...
      <section className="relative min-h-[70vh] flex items-center text-white">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 pt-32 pb-20">
          ...
          <p className="mt-8 max-w-3xl text-lg text-gray-200">
            From IT modernization to AI-powered transformation, nexxovate partners with organizations 
            to deliver scalable, secure and future-ready digital capabilities.
          </p>
      ...
      <section className="py-28">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="mt-6 text-lg text-gray-600">
            We deliver deeply integrated services across technology, security, talent and transformation — 
      ...
      <section className="pb-28">
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-3 gap-10">
          ...
          {[
            ...
            <div
              key={i}
              className="group relative h-[340px] rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition"
            >
              <Image
                src={item.img}
                alt={item.title}
      ...
      <section className="bg-gray-50 py-28">
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <p className="mt-6 text-lg text-gray-600">
              Our delivery philosophy blends domain expertise, structured execution, governance 
              and ownership to consistently deliver measurable outcomes.
            </p>
          ...
          <div className="bg-white shadow-2xl rounded-3xl p-14">
            <h3 className="text-2xl font-semibold">Impact delivered</h3>
            <div className="grid grid-cols-2 gap-12 mt-10">
              <div>
                <p className="text-5xl font-bold bg-gradient-to-r from-pink-500 to-purple-600 bg-clip-text text-transparent">7.6+</p>
                <p className="text-gray-500 mt-2">Years Experience</p>
              </div>
              <div>
                <p className="text-5xl font-bold bg-gradient-to-r from-pink-500 to-purple-600 bg-clip-text text-transparent">24/7</p>
                <p className="text-gray-500 mt-2">Operational Readiness</p>
              </div>
              <div>
                <p className="text-5xl font-bold bg-gradient-to-r from-pink-500 to-purple-600 bg-clip-text text-transparent">100%</p>
                <p className="text-gray-500 mt-2">Client-Centric Delivery</p>
              </div>
              <div>
                <p className="text-5xl font-bold bg-gradient-to-r from-pink-500 to-purple-600 bg-clip-text text-transparent">Secure</p>
                <p className="text-gray-500 mt-2">By-Design Approach</p>
              </div>
            </div>
          </div>
        </div>
